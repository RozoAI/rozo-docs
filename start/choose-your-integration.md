...
* Bridge & Wallet API integrations can be tried end to end on [testnet](../testnet/README.md) before going live. MPP Router is mainnet only; start with small amounts.

...
- [ ] **Connect a backup wallet** — Go to Security settings on the web app and connect your wallet. This is your backup if you lose passkey access.
- [ ] **Add passkeys on other devices** — If you use both iPhone and Android, add a passkey on each device.
- [ ] **Verify your backup works** — Sign out and try signing in with your connected wallet to confirm it's set up correctly.
...
| Connected wallet | Security settings (web only) | Backup recovery method |
...
**If you lose access to your passkey entirely**, you can still recover your account using a connected wallet:

1. Open the web app on any device
2. Select "Sign in with Wallet"
3. Connect your wallet and approve the sign-in
4. Once signed in, go to **Security** and add a new passkey

{% hint style="warning" %}
**No connected wallet?** If you haven't connected a wallet and lose all passkey access, account recovery may not be possible. Always set up a backup sign-in method.
{% endhint %}
...
|---------------|--------------|
| Connect a wallet | Sign in from any device, independent of passkeys |
...
### How do I connect a wallet for backup?
...
{% hint style="info" %}
Your connected wallet becomes an alternative sign-in method. You can use it to access your account even if all your passkeys are lost.
{% endhint %}
...
- **Connected wallet**: Independent backup sign-in method
...
| Wallet connection | ✅ Supported | Set up in Security settings (web only) |
...
{% hint style="danger" %}
**Critical:** Since we don't support email or phone recovery, connecting a wallet is the **only way** to recover your account if you lose all passkey access. Set this up immediately after creating your account.
{% endhint %}
...
**Method 2: Using your connected wallet (if you don't have your Android)**

If you've already connected a wallet to your account:

1. Open the web app on your iPhone browser
2. Tap "Sign in" → Select "Sign in with Wallet"
3. Connect your wallet and approve the sign-in
...
- Connected wallet (works anywhere)

{% hint style="warning" %}
**Important:** We strongly recommend connecting a wallet as a backup sign-in method. This allows you to recover your account even if you lose access to all your passkey devices.
{% endhint %}
...
**Method 2: Using your connected wallet**
...
3. ✅ Connect a wallet → works on any device as backup
...
|----------|--------------------------------|-------------------------------|
| Created on Android, need on iPhone | Sign in via QR code → Add passkey | Sign in with wallet → Add passkey |
| Created on iPhone, need on Android | Sign in via QR code → Add passkey | Sign in with wallet → Add passkey |
| Lost all passkey devices | — | Sign in with wallet → Add new passkeys |
| New device, same ecosystem | Passkey syncs automatically | No action needed |

{% hint style="success" %}
**Pro tip:** Connect a wallet to your account immediately after signup. This is your safety net if you ever lose access to your passkey devices.
{% endhint %}
